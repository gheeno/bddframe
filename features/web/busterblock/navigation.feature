@web @headless @navigation @capability
Feature: Navigation — move between pages, history, tabs
  ...
  Scenario: Four equivalent navigate phrasings
    ...
    Then User should see "VHS Catalog"
    When User opens "[BUSTERBLOCK]/catalog.html"
    Then User should see "VHS Catalog"
    When User goes to "[BUSTERBLOCK]/catalog.html"
    Then User should see "VHS Catalog"
    When User is on "[BUSTERBLOCK]/catalog.html"
    Then User should see "VHS Catalog"
